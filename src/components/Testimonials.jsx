...
const TestimonialCard = ({ quote, author, role, avatarColor }) => (
  <div className="bg-white p-10 rounded-[32px] shadow-lg border border-zinc-100 relative group">
    ...
    <section className="py-24 bg-background overflow-hidden">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid md:grid-cols-2 gap-8 relative">
          ...
          <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[120%] h-[120%] bg-white/30 rounded-full blur-3xl -z-10 rotate-12"></div>
